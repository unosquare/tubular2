...
var popup_details_directive_1 = require('./popup-details.directive');
var TubularModule = (function () {
    ...
    TubularModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [grid_component_1.TubularGrid, column_header_component_1.ColumnHeader, grid_search_component_1.GridSearch, grid_pager_component_1.GridPager, grid_pager_info_component_1.GridPagerInfo, column_filter_dialog_component_1.ColumnFilterDialog, page_size_selector_component_1.PageSizeSelector, grid_export_component_1.ExportButton, grid_print_component_1.PrintButton, popup_details_directive_1.PopupDetails],
