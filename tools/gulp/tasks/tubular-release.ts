 ...
 */
task('tubular2:build-release', ['tubular2:prepare-release'], () => composeRelease('tubular'));

/**
 * Task that will build the material package. It will also copy all prebuilt themes and build
 * a bundled SCSS file for theming
 */
task('tubular2:prepare-release', sequenceTask(
  'tubular2:build',
  ['tubular2:copy-prebuilt-themes', 'tubular2:bundle-theming-scss']
));

/** Copies all prebuilt themes into the release package under `prebuilt-themes/` */
task('tubular2:copy-prebuilt-themes', () => {
...
task('tubular2:bundle-theming-scss', () => {
